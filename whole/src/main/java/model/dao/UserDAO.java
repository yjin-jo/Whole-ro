...
public class UserDAO {
	...
	public int create(User user) throws SQLException {
        ...
        Object[] param = new Object[] {user.getUserId(), user.getEmail(), 
                ...
                user.getIntrodution(), user.getInterest(), user.getAddress(),
                user.getReportCount()};             
    ...
    public int update(User user) throws SQLException {
        String sql = "UPDATE USER_TABLE "
                    + "SET password=?, name=?, introdution=?, interest=?, address=? "
                    + "WHERE email=?";
     ...
     */
    public List<User> findUserList(String interest) throws SQLException {
        String sql =  "SELECT nickname, introduction, interest "
                    + "FROM USER_TABLE "
                    + "WHERE interest=? " 
                    + "ORDER BY email";
